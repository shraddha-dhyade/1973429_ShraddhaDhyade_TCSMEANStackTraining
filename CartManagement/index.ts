class Item {
    ...
    constructor(public varId:number, public varName:string, public varPrice:string,public varImg:string){
        this.id = varId;
        this.name = varName;
        this.price = varPrice;
        this.img = varImg;
...
var cartItemArr:Item[] = new Array();
